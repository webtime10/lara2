            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Средние цены отелей</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card card-outline card-info mb-3">
                <div class="card-body">
                    <p class="mb-2">
                        Средние цены считаются автоматически в Laravel из таблицы <code>swiss_hotels</code>:
                        <code>AVG(price_usd)</code> по каждому кантону и классу 1 / 2 / 3.
                    </p>
                    <p class="mb-0 text-muted">
                        Эти же значения используются в <code>HotelBudgetCalculator</code> при расчёте проживания.
                        Чтобы обновить данные, сначала залейте отели:
                        <a href="{{ route('admin.budget.hotels.index') }}">Бюджет → Отели</a>.
                    </p>
                </div>
            </div>
                            ...
                            <tr>
                                ...
                                @foreach ($levels as $level)
                                    <th style="width: 170px;">
                                        ...
                                        <small class="text-muted">$/ночь, 2-местный</small>
                                    </th>
                                @endforeach
                        ...
                        <tbody>
                            @foreach ($rows as $row)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.budget.hotels.show', $region->slug) }}" class="btn btn-sm btn-outline-primary">
                                            Отели
                                        </a>
                                    </td>
                                </tr>
