                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form id="categoryForm" action="{{ route('admin.j-categories.update', $category->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                        ...
                                        @foreach($languages as $index => $language)
                                            ...
                                            <div class="tab-pane fade @if($index === 0) show active @endif"
                                                ...
                                                @include('admin.j-categories.partials.image-field', [
                                                    ...
                                                    'fieldId' => $c,
                                                    'label' => 'Изображение',
                                                    'saveUrl' => route('admin.j-categories.image', $category->id),
                                                ])
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="description_{{ $c }}" id="description_{{ $c }}" class="form-control js-category-description" rows="4">{{ old('description_'.$c, $desc->description ?? '') }}</textarea>
                                                </div>
                                                @include('admin.j-categories.partials.ideal-region-fields', ['c' => $c, 'desc' => $desc])
                                            </div>
                                        @endforeach
                                    </div>
                                @endif
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="manufacturer_id" id="manufacturer_id" class="form-control">
                                        ...
                                        @foreach($manufacturers as $m)
                                            <option value="{{ $m->id }}" {{ (string) old('manufacturer_id', $category->manufacturer_id) === (string) $m->id ? 'selected' : '' }}>
                                                {{ $m->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="tourist_region" id="tourist_region" class="form-control">
                                        ...
                                        @foreach($touristRegions as $regionKey => $regionLabel)
                                            <option value="{{ $regionKey }}" {{ (string) old('tourist_region', $category->tourist_region) === (string) $regionKey ? 'selected' : '' }}>
                                                {{ $regionLabel }}
                                            </option>
                                        @endforeach
                                    </select>
