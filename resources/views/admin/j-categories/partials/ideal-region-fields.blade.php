{{-- Ideal Region (Япония) — шаги из config/japan_ideal_region_category_fields.php --}}
@php
    $irSteps = (array) config('japan_ideal_region_category_fields.steps', []);
    $irSlots = (array) config('japan_ideal_region_category_fields.step_slots', []);
    $irLabels = (array) config('japan_ideal_region_category_fields.labels', []);
    $irRules = (array) config('japan_ideal_region_category_fields.selection_rules', []);
