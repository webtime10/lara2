                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <form id="categoriesBulkDeleteForm" method="post" action="{{ route('admin.j-categories.bulk-delete') }}" class="d-inline">
                                @csrf
                                <button
                                    type="submit"
                            ...
                            <a href="{{ route('admin.j-categories.create') }}" class="btn btn-primary float-right">
                                    ...
                                    <tbody>
                                        @forelse($categories as $item)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $d->name ?? '—' }}</td>
                                                <td>{{ $item->touristRegionLabel() !== '' ? $item->touristRegionLabel() : '—' }}</td>
                                                ...
                                                <td>
                                                    <a href="{{ route('admin.j-categories.edit', $item->id) }}" class="btn btn-info btn-sm">
                                                        <i class="fas fa-pencil-alt"></i>
                                                    </a>
                                                    <form action="{{ route('admin.j-categories.destroy', $item->id) }}" method="post" class="d-inline">
                                                        @csrf
                                                        @method('DELETE')
